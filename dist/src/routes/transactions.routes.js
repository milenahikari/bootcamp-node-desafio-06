...
transactionsRouter.post('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, title, value, type, category, createTransactionRepository, transaction;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = request.body, title = _a.title, value = _a.value, type = _a.type, category = _a.category;
                createTransactionRepository = new CreateTransactionService_1.default();
                return [4 /*yield*/, createTransactionRepository.execute({
                        title: title,
                        value: value,
                        type: type,
                        category: category,
...
transactionsRouter.post('/import', upload.single('file'), function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var path, imporTransactionService, transactions;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                path = request.file.path;
                imporTransactionService = new ImportTransactionsService_1.default();
                return [4 /*yield*/, imporTransactionService.execute(path)];
            case 1:
                transactions = _a.sent();
