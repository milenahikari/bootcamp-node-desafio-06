...
var TransactionsRepository = /** @class */ (function (_super) {
    ...
    TransactionsRepository.prototype.getBalance = function () {
        return __awaiter(this, void 0, void 0, function () {
            var transactionsRepository, transactions, incomes, sumIncomes, outcomes, sumOutcomes;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        incomes = transactions.filter(function (item) { return item.type === 'income'; });
                        sumIncomes = incomes.reduce(function (total, current) { return total + current.value; }, 0);
                        outcomes = transactions.filter(function (item) { return item.type === 'outcome'; });
                        sumOutcomes = outcomes.reduce(function (total, current) { return total + current.value; }, 0);
                        return [2 /*return*/, {
                                income: sumIncomes,
                                outcome: sumOutcomes,
