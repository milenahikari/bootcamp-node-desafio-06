...
var ImportTransactionsService = /** @class */ (function () {
    ...
    ImportTransactionsService.prototype.execute = function (path) {
        return __awaiter(this, void 0, void 0, function () {
            var readStream, parser, transactions, createTransaction, transactionsResult, _i, transactions_1, item, transaction;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        readStream = fs_1.default.createReadStream(path);
                        parser = readStream.pipe(csv_parser_1.default({
                        ...
                        transactions = [];
                        parser.on('data', function (transaction) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                        ...
                        return [4 /*yield*/, new Promise(function (resolve) { return parser.on('end', resolve); })];
                    case 1:
                        _a.sent();
                    ...
                    case 4:
                        _i++;
                        return [3 /*break*/, 2];
                    case 5: return [2 /*return*/, transactionsResult];
                }
            });
        });
    };
